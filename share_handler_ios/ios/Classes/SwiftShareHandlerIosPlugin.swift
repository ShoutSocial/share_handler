...
public class SwiftShareHandlerIosPlugin: NSObject, FlutterPlugin, FlutterStreamHandler, FLTShareHandlerApi {
    
    
//     public static func register(with registrar: FlutterPluginRegistrar) {
//       let channel = FlutterMethodChannel(name: "share_handler_ios", binaryMessenger: registrar.messenger())
//       let instance = SwiftShareHandlerIosPlugin()
...
//     }
    ...
    // -> see Example app
    public static let instance = SwiftShareHandlerIosPlugin()

    public static func register(with registrar: FlutterPluginRegistrar) {
        let messenger : FlutterBinaryMessenger = registrar.messenger()
        let api : FLTShareHandlerApi & NSObjectProtocol = SwiftShareHandlerIosPlugin.init()
        FLTShareHandlerApiSetup(messenger, api)
...
//                    let sharedMedia = FLTSharedMedia.fromMap(nil)
...
//            return true
    ...
    func getInitialSharedMedia(_ error: AutoreleasingUnsafeMutablePointer<FlutterError?>) -> FLTSharedMedia? {
        let sharedMedia = FLTSharedMedia.fromJson(data: initialMediaData)
        return sharedMedia
    }
    ...
    func recordSentMessage(_ media: FLTSharedMedia?, error: AutoreleasingUnsafeMutablePointer<FlutterError?>) {
        ...
        if let media = media {
            ...
            error.pointee = FlutterError.init(code: "NATIVE_ERR", message: "Error: decoding FLTSharedMedia", details: nil)
        }
    }
